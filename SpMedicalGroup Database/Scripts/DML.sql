...
-- INSERT INTO CLINICAS(RAZAO_SOCIAL, NOME_FANTASIA, CNPJ, LOGRADOURO, NUMERO, BAIRRO, CIDADE, ESTADO, CEP)
-- VALUES	('SPMedGroup', 'SPMedicalGroup', 123456789013, 'Alameda Barão de Limeira', 539, 'Santa Cecília', 'São Paulo', 'SP', 01202002)
